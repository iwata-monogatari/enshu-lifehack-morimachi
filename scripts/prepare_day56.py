...
S3="https://www.town.morimachi.shizuoka.jp/gyosei/machinososhiki/teijusuishinka/ijukoryugakari/2/2/3043akiyakazaisyobun.html"
S4="https://www.town.morimachi.shizuoka.jp/material/files/group/10/secondplan.pdf"
...
for (_,p),s in zip(sections,supplements): p.append(s)

facts=[
("森町空き家バンク登録には登録申込書・同意書・チェックリストの提出が必要である",S1),
("土地と建物の所有者が異なる場合は土地所有者の同意書が必要である",S1),
("町は現地調査と審査を経て物件情報を公開する",S1),
("空き家情報は申請時点の状況に基づくため実際の状況と異なる場合がある",S1),
("森町の確認票は水道種類と下水道・浄化槽・くみ取り等を分けている",S2),
("森町の確認票は雨漏り・床白蟻・傾き腐食・外壁・躯体基礎を確認する",S2),
("森町の確認票は害獣と残置物の有無も確認する",S2),
("森町の支援はバンク登録可能物件の残置物処分と改修工事を対象として案内する",S3),
("改修対象には台所・風呂・トイレ・電気ガス水道・内装屋根外壁が含まれる",S3),
("残置物対象にはごみ・家電・家財委託・清掃・支障木伐採が含まれる",S3),
("補助要件に空き家バンクへ二年以上継続登録することが含まれる",S3),
("残置物処分委託は一般廃棄物処理業許可業者へ依頼する要件がある",S3),
("案内上限は残置物処分十万円・改修工事三十万円で予算範囲内である",S3),
("森町は所有者の維持管理相談に助言し必要に応じ管理業者を紹介する方針である",S4),
("国土交通省は建物状況調査の手引きと調査の限界を案内している",S5),
]

record={"id":124,"verified_facts":[{"statement":s,"source_url":u} for s,u in facts],
"morimachi_conditions":["安全確認・管理・登録前改修・契約後工事を分ける","残置物処分と改修工事を別会計にする","補助の対象・時期・変更手続を契約前に町へ確認する","複数見積りを同じ写真番号と対象範囲で比較する"],
"section_headings":[h for h,_ in sections],"section_paragraphs":[{"heading":h,"paragraphs":p} for h,p in sections],
"faqs":[
{"question":"空き家バンク登録前の修繕見積りは何から始めますか？","answer":"現況写真へ番号を振り、安全対応、設備、残置物、専門確認を分けます。調査、応急対応、登録前改修、契約後工事を別欄にして、同じ条件で業者へ見積りを依頼してください。"},
{"question":"森町の補助上限を見積額から先に差し引いてよいですか？","answer":"先に差し引かないでください。対象者、対象経費、二年以上の登録、申請時期、予算状況などを契約・着工前に森町へ確認する必要があります。"},
{"question":"残置物処分とリフォームを一つの見積書にできますか？","answer":"依頼自体は業者へ確認できますが、比較表では別会計にしてください。森町の案内も対象経費と上限を残置物処分と改修工事で分けています。"},
{"question":"工事業者の現地見積りは建物状況調査と同じですか？","answer":"同じとは限りません。工事見積り、原因調査、法令上の建物状況調査は目的と実施者、対象範囲が異なるため、それぞれの成果物を確認してください。"}],
"sources":[
{"url":S1,"title":"森町 空き家・空き地バンクの登録案内","status":"verified-http-200","checked_at":"2026-08-16"},
{"url":S2,"title":"森町 空き家・空き地バンク確認票","status":"verified-http-200","checked_at":"2026-08-16"},
{"url":S3,"title":"森町 空き家等利活用推進支援費用補助金","status":"verified-http-200","checked_at":"2026-08-16"},
...
(ROOT/"work"/"day56-research-124.json").write_text(json.dumps({"records":[record]},ensure_ascii=False,indent=2)+"\n",encoding="utf-8")
topics=json.loads((ROOT/"data"/"seo-phase4-topics.json").read_text(encoding="utf-8"))
for t in topics:
    if t["id"]==124:
        t["title"]="森町の空き家バンク登録前に作る｜修繕・調査・残置物の見積り表"
        t["search_intent"]="空き家バンク登録前の所有者が、修繕・現況調査・残置物処分・補助確認を同じ条件で比較できる見積り表を作りたい"
