...
S2 = "https://www.town.morimachi.shizuoka.jp/gyosei/machinososhiki/teijusuishinka/sumaishiengakari/2/2222.html"
S3 = "https://www.town.morimachi.shizuoka.jp/material/files/group/10/secondplan.pdf"
S4 = "https://www.town.morimachi.shizuoka.jp/gyosei/machinososhiki/seisakukikakuka/promotionsenryakugakari/4/505.html"
S5 = "https://www.mlit.go.jp/jutakukentiku/house/akiya-taisaku/articles/2024020104.html"
S6 = "https://www.mlit.go.jp/jutakukentiku/house/content/001732456.pdf"
...
facts = [
("森町の空き家・空き地バンクは町が登録物件の管理を行わないと明記する", S1),
("森町の空き家・空き地バンクでは見学・交渉・契約を希望者と所有者双方で行う", S1),
("森町の空き家・空き地バンクは町が交渉や契約を行わないと案内する", S1),
("森町の空き家・空き地バンクは交渉希望者の情報を所有者へ知らせる仕組みである", S1),
("森町の第2期空家等対策計画は令和4年度の町内空き家等実態調査を踏まえて策定された", S2),
("森町の第2期空家等対策計画の対象地区は森町全域である", S2),
("森町の第2期空家等対策計画の期間は令和5年度11月から令和14年度末までである", S2),
("森町の計画資料は門塀・擁壁・雑草立木・屋根・外壁・傾き・樋・窓等を調査項目にする", S3),
("森町の計画資料は悪臭・害獣害虫・第三者へ危害を与える可能性も調査項目にする", S3),
("森町の主要施設一覧は袋井消防署森分署の一般電話と所在地を掲載する", S4),
("森町の主要施設一覧は袋井警察署森分庁舎の一般電話と所在地を掲載する", S4),
("国土交通省は自ら管理が難しい場合に空き家管理業者や修繕業者の利用検討を案内する", S5),
("国の管理指針は建物全体・外装材・屋根材・屋内・排水設備を点検対象例にする", S6),
("国の管理指針は敷地・門塀・擁壁・立木・動物を点検対象例にする", S6),
("国の管理指針は外装材や屋根材の剥落・破損に対する補修や撤去を管理行為例にする", S6),
("国の管理指針は立木の腐朽や枝のはみ出しに対する伐採・枝切除を管理行為例にする", S6),
]

record = {
 "id":126,
 "verified_facts":[{"statement":s,"source_url":u} for s,u in facts],
 "morimachi_conditions":["町が物件管理を行わないことを前提に所有者側の担当を決める","近隣協力者へ立入・作業・専門判断を求めない","緊急通報と平常時の所有者連絡を分ける","連絡先の同意・共有範囲・更新日を記録する"],
 "section_headings":[h for h,_ in sections],
 "section_paragraphs":[{"heading":h,"paragraphs":p} for h,p in sections],
 "faqs":[
  {"question":"空き家の近隣連絡カードには何を載せますか？","answer":"物件番号、所有者側の受付、第二連絡先、現地確認者、緊急時は119・110を優先すること、伝えてほしい観察項目、更新日を載せます。鍵番号や相続資料など不要な個人情報は載せません。"},
  {"question":"近所の人に定期的な見回りをお願いしてよいですか？","answer":"善意の臨時連絡と継続的な管理は分けてください。頻度、立入権限、費用、報告を伴う管理は家族や管理業者等と明確に決め、近隣へ当然の役割として求めません。"},
  {"question":"火災や倒壊の危険でも先に所有者へ連絡しますか？","answer":"生命や身体へ差し迫る危険、火災や事件では、所有者への順番待ちをせず119または110へ通報します。所有者カードは通報後の物件情報や鍵担当の共有に使います。"},
  {"question":"連絡先はどのくらいの頻度で更新しますか？","answer":"少なくとも年一回と、所有者・家族担当・管理契約・電話番号が変わったときに確認します。配布先と同意も見直し、旧版を回収または無効化してください。"}],
 "sources":[
  {"url":S1,"title":"森町 空き家・空き地バンク","status":"verified-http-200","checked_at":"2026-08-16"},
  {"url":S2,"title":"森町 第2期空家等対策計画","status":"verified-http-200","checked_at":"2026-08-16"},
  {"url":S3,"title":"森町 第2期空家等対策計画 PDF","status":"verified-http-200","checked_at":"2026-08-16"},
  {"url":S4,"title":"森町 主要施設・諸団体一覧","status":"verified-http-200","checked_at":"2026-08-16"},
  {"url":S5,"title":"国土交通省 空き家の管理のやり方","status":"verified-http-200","checked_at":"2026-08-16"},
  {"url":S6,"title":"国土交通省 空き家の管理指針","status":"verified-http-200","checked_at":"2026-08-16"}],
}

(ROOT/"work"/"day58-research-126.json").write_text(json.dumps({"records":[record]},ensure_ascii=False,indent=2)+"\n",encoding="utf-8")
topics=json.loads((ROOT/"data"/"seo-phase4-topics.json").read_text(encoding="utf-8"))
for t in topics:
 if t["id"]==126:
  t["title"]="森町の空き家で近隣から異常連絡を受ける｜所有者・現地担当の連絡カード"
  t["search_intent"]="空き家の異常を近隣から所有者へ安全に伝え、現地確認・専門業者・緊急通報へつなぐ連絡カードを作りたい"
...
print("day58 proposal written")

def update_public_surfaces():
 page_url="/vacant-house/vacant-house-neighbor-contact/"
 full_url="https://morimachi.enshu-lifehack.com"+page_url
 p=ROOT/"sitemap.xml"; s=p.read_text(encoding="utf-8")
 if full_url not in s:
  s=s.replace("</urlset>",f'<url><loc>{full_url}</loc><lastmod>2026-08-16</lastmod></url>\n</urlset>')
  p.write_text(s,encoding="utf-8")
 p=ROOT/"search-index.json"; a=json.loads(p.read_text(encoding="utf-8"))
 if not any(x.get("href")==page_url for x in a):
  a.append({"href":page_url,"icon":"🏠","title":"森町の空き家で近隣から異常連絡を受ける｜所有者・現地担当の連絡カード","category":"空き家","hub":"property","kind":"連絡","summary":"近隣からの異常情報を所有者・現地担当・緊急窓口へ渡す連絡カード","keyword":"森町 空き家 近隣 緊急連絡 所有者","aliases":["空き家連絡カード","近隣異常連絡","遠方所有者連絡網"],"needs":["空き家の異常連絡を確実に受けたい"],"department":["定住推進課"],"audience":["空き家所有者","遠方の家族"],"verified":"2026-08-16","lead":"近隣の善意を管理責任に変えず、見えた事実を所有者側へ届け、現地確認や緊急通報へつなぐ一件カードです。"})
  p.write_text(json.dumps(a,ensure_ascii=False,separators=(",",":")),encoding="utf-8")
 p=ROOT/"index.html"; s=p.read_text(encoding="utf-8").replace("サイト全体の公開ページは 782 件です","サイト全体の公開ページは 783 件です"); p.write_text(s,encoding="utf-8")
